            ...
            <div className="flex-grow flex flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        {(error || localError) && <p className="text-red-500 text-sm text-center">{localError || error}</p>}
                    ...
                    <p className="mt-10 text-center text-sm text-gray-400">
                        ...
                        <Link to="/login" className="font-semibold leading-6 text-primary hover:text-indigo-400">
                            Sign in
                        </Link>
                    </p>
                </div>
